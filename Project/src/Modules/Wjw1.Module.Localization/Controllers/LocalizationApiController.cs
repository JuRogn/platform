...
using Wjw1.Module.Localization.ViewModels;
...
namespace SimplCommerce.Module.Localization.Controllers
{
    ...
    {
        private const string STANDARD_CULTURE_ID = "100";
        ...
        {
            var cultures = await _cultureRepository.GetAll().ToArrayAsync();
            return Ok(cultures);
        }
        ...
        public async Task<IActionResult> UpdateResource(string cultureId, [FromBody] IList<ResourceItemVm> model)
        {
            ...
            await _resourceRepository.CommitAsync();
