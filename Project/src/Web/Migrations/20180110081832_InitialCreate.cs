        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnterpriseId = table.Column<string>(maxLength: 256, nullable: true),
                    RoleName = table.Column<string>(maxLength: 100, nullable: true),
                    System = table.Column<bool>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<string>(nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
                    SysRoleId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetRoles_SysRoleId",
                        column: x => x.SysRoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_SysUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_SysRoleId",
                table: "AspNetUserRoles",
                column: "SysRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_SysUserId",
                table: "AspNetUserRoles",
                column: "SysUserId");
